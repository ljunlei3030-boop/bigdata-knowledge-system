...
const repositoryLink = 'https://github.com/ljunlei3030-boop/bigdata-knowledge-system'
...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'GitHub', link: repositoryLink }
    ],
    search: {
      provider: 'local'
    },
    ...
    sidebar: {
      '/guide/': [guideSidebar, questionsSidebar],
      '/collection/': [collectionSidebar, lakehouseSidebar],
      '/storage/': [storageSidebar, lakehouseSidebar],
      '/compute/': [computeSidebar, optimizationSidebar, questionsSidebar],
      '/lakehouse/': [lakehouseSidebar, collectionSidebar, storageSidebar, computeSidebar],
      '/modeling/': [modelingSidebar, governanceSidebar],
      '/governance/': [governanceSidebar, modelingSidebar],
      '/optimization/': [optimizationSidebar, computeSidebar, casesSidebar],
      '/scheduler/': [schedulerSidebar, lakehouseSidebar, governanceSidebar],
      '/questions/': [questionsSidebar, computeSidebar, governanceSidebar],
      '/cases/': [casesSidebar, optimizationSidebar, questionsSidebar]
    }
  }
})
